...
insert into book_publisher(id, name, cnpj) values(1, 'SuaLivraria', '123345')

insert into book(id, title, description) values(1, 'Altas aventuras', 'Livro sobre aventuras')
